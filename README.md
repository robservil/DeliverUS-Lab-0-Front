...
`npx expo install react-native-web@~0.19.13 react-dom@18.3.1 @expo/metro-runtime`
7. Finally, run `npm start` and press `w` (Run in web browser) once terminal ask you about deployment options
   * A new tab/window on your browser should open http://localhost:8081/ showing the demo projects. If not automatically opened, run your browser and navigate to: http://localhost:19006
